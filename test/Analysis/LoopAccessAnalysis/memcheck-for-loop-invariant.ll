...
; CHECK: Printing analysis 'Loop Access Analysis' for function 'f'
...
; CHECK: Printing analysis 'Loop Access Analysis' for function 'foo'
; CHECK: Memory dependences are safe with run-time checks
; CHECK: Run-time memory checks:
; CHECK: Check {{[0-9]+}}:
...
; CHECK: Printing analysis 'Loop Access Analysis' for function 'needs_check'
; CHECK: Memory dependences are safe with run-time checks
; CHECK: Run-time memory checks:
; CHECK: Check {{[0-9]+}}:
; CHECK:   Comparing group ({{.*}}):
