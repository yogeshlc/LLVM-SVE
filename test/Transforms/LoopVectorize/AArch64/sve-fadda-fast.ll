; RUN: opt -S < %s -O3 -basicaa -loop-vectorize -force-scalable-vectorization -force-vector-predication 2>&1 | FileCheck %s
...
; CHECK-LABEL: @reduce
; CHECK-NOT: @llvm.aarch64.sve.adda.
; CHECK: @llvm.aarch64.sve.addv.
