...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %17 = add nuw nsw i64 %index, elementcount (<n x 4 x i64> undef)
  %18 = seriesvector i64 %17, 1 as <n x 4 x i64>
  %19 = icmp ult <n x 4 x i64> %18, shufflevector (<n x 4 x i64> insertelement (<n x 4 x i64> undef, i64 1024, i32 0), <n x 4 x i64> undef, <n x 4 x i32> zeroinitializer)
  %predicate.next = propff <n x 4 x i1> %predicate, %19
  %20 = test first true <n x 4 x i1> %predicate.next
  br i1 %20, label %vector.body, label %for.cond.cleanup, !llvm.loop !7
