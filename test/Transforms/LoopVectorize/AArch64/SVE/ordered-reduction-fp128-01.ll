; RUN: opt  -mtriple aarch64-linux-generic -march=armv8-a -mattr=+sve -S < %s  -basicaa -loop-vectorize -force-scalable-vectorization -force-vector-predication --force-vector-interleave=2  -force-vector-width=1 2>&1 | FileCheck %s
