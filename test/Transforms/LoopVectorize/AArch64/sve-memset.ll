; RUN: opt -mtriple aarch64-none-linux-gnu -mattr=+sve -O3 -loop-vectorize \
...
; CHECK-NOT: memset
; CHECK:  call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> zeroinitializer
; CHECK:  call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> zeroinitializer
; CHECK:  call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> zeroinitializer
; CHECK:  call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> zeroinitializer
; CHECK: ret
...
; THRESHOLD:  call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> zeroinitializer
; THRESHOLD:  call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> zeroinitializer
; THRESHOLD:  call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> zeroinitializer
; THRESHOLD:  call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> zeroinitializer
; THRESHOLD:  call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> zeroinitializer
...
; CHECK-NOT: memset
; CHECK:  %.splatinsert = insertelement <n x 8 x i8> undef, i8 %val, i32 0
; CHECK:  %.splat = shufflevector <n x 8 x i8> %.splatinsert, <n x 8 x i8> undef, <n x 8 x i32> zeroinitializer
; CHECK:  %[[SPLAT:[0-9]+]] = bitcast <n x 8 x i8> %.splat to <n x 2 x i32>
; CHECK-LABEL: vector.body:
; CHECK:  call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> %[[SPLAT]]
; CHECK:  call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> %[[SPLAT]]
; CHECK:  call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> %[[SPLAT]]
; CHECK:  call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> %[[SPLAT]]
; CHECK: ret
...
; CHECK-NOT: memset
; CHECK: call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> bitcast (<n x 8 x i8> shufflevector (<n x 8 x i8> insertelement (<n x 8 x i8> undef, i8 1, i32 0), <n x 8 x i8> undef, <n x 8 x i32> zeroinitializer) to <n x 2 x i32>)
; CHECK: call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> bitcast (<n x 8 x i8> shufflevector (<n x 8 x i8> insertelement (<n x 8 x i8> undef, i8 1, i32 0), <n x 8 x i8> undef, <n x 8 x i32> zeroinitializer) to <n x 2 x i32>)
; CHECK: call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> bitcast (<n x 8 x i8> shufflevector (<n x 8 x i8> insertelement (<n x 8 x i8> undef, i8 1, i32 0), <n x 8 x i8> undef, <n x 8 x i32> zeroinitializer) to <n x 2 x i32>)
; CHECK: call void @llvm.masked.scatter.nxv2i32(<n x 2 x i32> bitcast (<n x 8 x i8> shufflevector (<n x 8 x i8> insertelement (<n x 8 x i8> undef, i8 1, i32 0), <n x 8 x i8> undef, <n x 8 x i32> zeroinitializer) to <n x 2 x i32>)
; CHECK: ret
