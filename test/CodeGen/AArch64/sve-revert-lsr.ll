...
vector.body:
  ...
  %3 = add nuw nsw i64 %index, elementcount (<n x 4 x i64> undef)
  %4 = call <n x 4 x i1> @llvm.aarch64.sve.whilelo.nxv4i1.i64(i64 %3, i64 %N)
  %5 = test first true <n x 4 x i1> %4
  %lsr.iv.next = add i64 %lsr.iv, mul (i64 elementcount (<n x 4 x i64> undef), i64 4)
...
vector.body:
  ...
  %index.next = add nuw nsw i64 %index, elementcount (<n x 4 x i64> undef)
  %0 = add nuw nsw i64 %index, elementcount (<n x 4 x i64> undef)
  %1 = call <n x 4 x i1> @llvm.aarch64.sve.whilelo.nxv4i1.i64(i64 %0, i64 %N)
  %2 = test first true <n x 4 x i1> %1
  %scevgep = getelementptr i1, i1* %lsr.upd, i64 mul (i64 elementcount (<n x 4 x i64> undef), i64 4)
