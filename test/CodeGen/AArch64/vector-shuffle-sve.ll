...
define void @uzp1_b_16(<n x 16 x i8> *%a, <n x 16 x i8> *%b,
                       <n x 16 x i8> *%c) {
...
; CHECK: ret
  ...
  %in1 = load <n x 16 x i8> , <n x 16 x i8> *%c
  %res = shufflevector <n x 16 x i8> %in0, <n x 16 x i8> %in1,
                       <n x 16 x i16> seriesvector (i16 0, i16 2)
  store <n x 16 x i8> %res, <n x 16 x i8> *%a
  ret void
}

define void @uzp1_b_32(<n x 16 x i8> *%a, <n x 16 x i8> *%b,
                       <n x 16 x i8> *%c) {
...
; CHECK: ret
  ...
  %in1 = load <n x 16 x i8> , <n x 16 x i8> *%c
  %res = shufflevector <n x 16 x i8> %in0, <n x 16 x i8> %in1,
                       <n x 16 x i32> seriesvector (i32 0, i32 2)
  store <n x 16 x i8> %res, <n x 16 x i8> *%a
  ret void
}

define void @uzp1_b_64(<n x 16 x i8> *%a, <n x 16 x i8> *%b,
                       <n x 16 x i8> *%c) {
...
; CHECK: ret
  ...
  %in1 = load <n x 16 x i8> , <n x 16 x i8> *%c
  %res = shufflevector <n x 16 x i8> %in0, <n x 16 x i8> %in1,
                       <n x 16 x i64> seriesvector (i64 0, i64 2)
  store <n x 16 x i8> %res, <n x 16 x i8> *%a
  ret void
}
...
; CHECK: ret
  ...
  %in1 = load <n x 8 x i16> , <n x 8 x i16> *%c
  %res = shufflevector <n x 8 x i16> %in0, <n x 8 x i16> %in1,
                       <n x 8 x i16> seriesvector (i16 0, i16 2)
  store <n x 8 x i16> %res, <n x 8 x i16> *%a
  ret void
}
...
; CHECK: ret
  ...
  %in1 = load <n x 4 x i32> , <n x 4 x i32> *%c
  %res = shufflevector <n x 4 x i32> %in0, <n x 4 x i32> %in1,
                       <n x 4 x i32> seriesvector (i32 0, i32 2)
  store <n x 4 x i32> %res, <n x 4 x i32> *%a
  ret void
}

define void @uzp1_s_double(<n x 8 x i32> *%a, <n x 8 x i32> *%b,
                           <n x 8 x i32> *%c) {
...
; CHECK: ret
  ...
  %in1 = load <n x 8 x i32> , <n x 8 x i32> *%c
  %res = shufflevector <n x 8 x i32> %in0, <n x 8 x i32> %in1,
                       <n x 8 x i32> seriesvector (i32 0, i32 2)
  store <n x 8 x i32> %res, <n x 8 x i32> *%a
  ret void
}
...
; CHECK: ret
  ...
  %in1 = load <n x 2 x i64> , <n x 2 x i64> *%c
  %res = shufflevector <n x 2 x i64> %in0, <n x 2 x i64> %in1,
                       <n x 2 x i64> seriesvector (i64 0, i64 2)
  store <n x 2 x i64> %res, <n x 2 x i64> *%a
  ret void
}

define void @uzp2_b_16(<n x 16 x i8> *%a, <n x 16 x i8> *%b,
                       <n x 16 x i8> *%c) {
...
; CHECK: ret
  ...
  %in1 = load <n x 16 x i8> , <n x 16 x i8> *%c
  %res = shufflevector <n x 16 x i8> %in0, <n x 16 x i8> %in1,
                       <n x 16 x i16> seriesvector (i16 1, i16 2)
  store <n x 16 x i8> %res, <n x 16 x i8> *%a
  ret void
}

define void @uzp2_b_32(<n x 16 x i8> *%a, <n x 16 x i8> *%b,
                       <n x 16 x i8> *%c) {
...
; CHECK: ret
  ...
  %in1 = load <n x 16 x i8> , <n x 16 x i8> *%c
  %res = shufflevector <n x 16 x i8> %in0, <n x 16 x i8> %in1,
                       <n x 16 x i32> seriesvector (i32 1, i32 2)
  store <n x 16 x i8> %res, <n x 16 x i8> *%a
  ret void
}

define void @uzp2_b_64(<n x 16 x i8> *%a, <n x 16 x i8> *%b,
                       <n x 16 x i8> *%c) {
...
; CHECK: ret
  ...
  %in1 = load <n x 16 x i8> , <n x 16 x i8> *%c
  %res = shufflevector <n x 16 x i8> %in0, <n x 16 x i8> %in1,
                       <n x 16 x i64> seriesvector (i64 1, i64 2)
  store <n x 16 x i8> %res, <n x 16 x i8> *%a
  ret void
}
...
; CHECK: ret
  ...
  %in1 = load <n x 8 x i16> , <n x 8 x i16> *%c
  %res = shufflevector <n x 8 x i16> %in0, <n x 8 x i16> %in1,
                       <n x 8 x i16> seriesvector (i16 1, i16 2)
  store <n x 8 x i16> %res, <n x 8 x i16> *%a
  ret void
}
...
; CHECK: ret
  ...
  %in1 = load <n x 4 x i32> , <n x 4 x i32> *%c
  %res = shufflevector <n x 4 x i32> %in0, <n x 4 x i32> %in1,
                       <n x 4 x i32> seriesvector (i32 1, i32 2)
  store <n x 4 x i32> %res, <n x 4 x i32> *%a
  ret void
}
...
; CHECK: ret
  %res = shufflevector <n x 4 x float> %a, <n x 4 x float> %b,
                       <n x 4 x i32> seriesvector (i32 1, i32 2)
  ret <n x 4 x float> %res
}

define void @uzp2_s_double(<n x 8 x i32> *%a, <n x 8 x i32> *%b,
                           <n x 8 x i32> *%c) {
...
; CHECK: ret
  ...
  %in1 = load <n x 8 x i32> , <n x 8 x i32> *%c
  %res = shufflevector <n x 8 x i32> %in0, <n x 8 x i32> %in1,
                       <n x 8 x i32> seriesvector (i32 1, i32 2)
  store <n x 8 x i32> %res, <n x 8 x i32> *%a
  ret void
}
...
; CHECK: ret
  ...
  %in1 = load <n x 2 x i64> , <n x 2 x i64> *%c
  %res = shufflevector <n x 2 x i64> %in0, <n x 2 x i64> %in1,
                       <n x 2 x i64> seriesvector (i64 1, i64 2)
  store <n x 2 x i64> %res, <n x 2 x i64> *%a
  ret void
}
