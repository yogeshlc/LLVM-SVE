...
; CHECK: ld1rb {[[REG:z[0-9]+]].b}, p{{[0-9]+}}/z, [sp, #15]
; CHECK: st1b {[[REG]].b},
  %valp = alloca i8
...
; CHECK: ld1rb {[[REG:z[0-9]+]].h}, p{{[0-9]+}}/z, [sp, #15]
; CHECK: st1h {[[REG]].h},
  %valp = alloca i8
  call void @setmem_i8(i8 *%valp)
  %val = load i8, i8* %valp
...
; CHECK: ld1rb {[[REG:z[0-9]+]].s}, p{{[0-9]+}}/z, [sp, #15]
; CHECK: st1w {[[REG]].s},
  %valp = alloca i8
  call void @setmem_i8(i8 *%valp)
  %val = load i8, i8* %valp
...
; CHECK: ld1rb {[[REG:z[0-9]+]].d}, p{{[0-9]+}}/z, [sp, #15]
; CHECK: st1d {[[REG]].d},
  %valp = alloca i8
  call void @setmem_i8(i8 *%valp)
  %val = load i8, i8* %valp
...
; CHECK: ld1rsb {[[REG:z[0-9]+]].h}, p{{[0-9]+}}/z, [sp, #15]
; CHECK: st1h {[[REG]].h},
  %valp = alloca i8
  call void @setmem_i8(i8 *%valp)
  %val = load i8, i8* %valp
...
; CHECK: ld1rsb {[[REG:z[0-9]+]].s}, p{{[0-9]+}}/z, [sp, #15]
; CHECK: st1w {[[REG]].s},
  %valp = alloca i8
  call void @setmem_i8(i8 *%valp)
  %val = load i8, i8* %valp
...
; CHECK: ld1rsb {[[REG:z[0-9]+]].d}, p{{[0-9]+}}/z, [sp, #15]
; CHECK: st1d {[[REG]].d},
  %valp = alloca i8
  call void @setmem_i8(i8 *%valp)
  %val = load i8, i8* %valp
...
; CHECK: ld1rh {[[REG:z[0-9]+]].h}, p{{[0-9]+}}/z, [sp, #14
; CHECK: st1h {[[REG]].h},
  %valp = alloca i16
...
; CHECK: ld1rh {[[REG:z[0-9]+]].s}, p{{[0-9]+}}/z, [sp, #14
; CHECK: st1w {[[REG]].s},
  %valp = alloca i16
  call void @setmem_i16(i16 *%valp)
  %val = load i16, i16* %valp
...
; CHECK: ld1rh {[[REG:z[0-9]+]].d}, p{{[0-9]+}}/z, [sp, #14
; CHECK: st1d {[[REG]].d},
  %valp = alloca i16
  call void @setmem_i16(i16 *%valp)
  %val = load i16, i16* %valp
...
; CHECK: ld1rsh {[[REG:z[0-9]+]].s}, p{{[0-9]+}}/z, [sp, #14
; CHECK: st1w {[[REG]].s},
  %valp = alloca i16
  call void @setmem_i16(i16 *%valp)
  %val = load i16, i16* %valp
...
; CHECK: ld1rsh {[[REG:z[0-9]+]].d}, p{{[0-9]+}}/z, [sp, #14
; CHECK: st1d {[[REG]].d},
  %valp = alloca i16
  call void @setmem_i16(i16 *%valp)
  %val = load i16, i16* %valp
