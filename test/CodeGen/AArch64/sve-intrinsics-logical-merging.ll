...
; CHECK-NEXT: ret
  %tmp = call <n x 16 x i8> @llvm.aarch64.sve.and.nxv16i8(<n x 16 x i1> %pg,
                                                          <n x 16 x i8> %a,
                                                          <n x 16 x i8> %b)
...
; CHECK-NEXT: ret
  %tmp = call <n x 8 x i16> @llvm.aarch64.sve.and.nxv8i16(<n x 8 x i1> %pg,
                                                          <n x 8 x i16> %a,
                                                          <n x 8 x i16> %b)
...
; CHECK-NEXT: ret
  %tmp = call <n x 4 x i32> @llvm.aarch64.sve.and.nxv4i32(<n x 4 x i1> %pg,
                                                          <n x 4 x i32> %a,
                                                          <n x 4 x i32> %b)
...
; CHECK-NEXT: ret
  %tmp = call <n x 2 x i64> @llvm.aarch64.sve.and.nxv2i64(<n x 2 x i1> %pg,
                                                          <n x 2 x i64> %a,
                                                          <n x 2 x i64> %b)
...
; CHECK-NEXT: ret
  %tmp = call <n x 16 x i8> @llvm.aarch64.sve.bic.nxv16i8(<n x 16 x i1> %pg,
                                                          <n x 16 x i8> %a,
                                                          <n x 16 x i8> %b)
  %out = select <n x 16 x i1> %pg, <n x 16 x i8> %tmp, <n x 16 x i8> zeroinitializer
  ret <n x 16 x i8> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 8 x i16> @llvm.aarch64.sve.bic.nxv8i16(<n x 8 x i1> %pg,
                                                          <n x 8 x i16> %a,
                                                          <n x 8 x i16> %b)
  %out = select <n x 8 x i1> %pg, <n x 8 x i16> %tmp, <n x 8 x i16> zeroinitializer
  ret <n x 8 x i16> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 4 x i32> @llvm.aarch64.sve.bic.nxv4i32(<n x 4 x i1> %pg,
                                                          <n x 4 x i32> %a,
                                                          <n x 4 x i32> %b)
  %out = select <n x 4 x i1> %pg, <n x 4 x i32> %tmp, <n x 4 x i32> zeroinitializer
  ret <n x 4 x i32> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 2 x i64> @llvm.aarch64.sve.bic.nxv2i64(<n x 2 x i1> %pg,
                                                          <n x 2 x i64> %a,
                                                          <n x 2 x i64> %b)
  %out = select <n x 2 x i1> %pg, <n x 2 x i64> %tmp, <n x 2 x i64> zeroinitializer
  ret <n x 2 x i64> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 16 x i8> @llvm.aarch64.sve.cnot.nxv16i8(<n x 16 x i8> %a,
                                                           <n x 16 x i1> %pg,
                                                           <n x 16 x i8> %b)
  %out = select <n x 16 x i1> %pg, <n x 16 x i8> %tmp, <n x 16 x i8> zeroinitializer
  ret <n x 16 x i8> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 8 x i16> @llvm.aarch64.sve.cnot.nxv8i16(<n x 8 x i16> %a,
                                                           <n x 8 x i1> %pg,
                                                           <n x 8 x i16> %b)
  %out = select <n x 8 x i1> %pg, <n x 8 x i16> %tmp, <n x 8 x i16> zeroinitializer
  ret <n x 8 x i16> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 4 x i32> @llvm.aarch64.sve.cnot.nxv4i32(<n x 4 x i32> %a,
                                                           <n x 4 x i1> %pg,
                                                           <n x 4 x i32> %b)
  %out = select <n x 4 x i1> %pg, <n x 4 x i32> %tmp, <n x 4 x i32> zeroinitializer
  ret <n x 4 x i32> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 2 x i64> @llvm.aarch64.sve.cnot.nxv2i64(<n x 2 x i64> %a,
                                                           <n x 2 x i1> %pg,
                                                           <n x 2 x i64> %b)
  %out = select <n x 2 x i1> %pg, <n x 2 x i64> %tmp, <n x 2 x i64> zeroinitializer
  ret <n x 2 x i64> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 16 x i8> @llvm.aarch64.sve.eor.nxv16i8(<n x 16 x i1> %pg,
                                                          <n x 16 x i8> %a,
                                                          <n x 16 x i8> %b)
  %out = select <n x 16 x i1> %pg, <n x 16 x i8> %tmp, <n x 16 x i8> zeroinitializer
  ret <n x 16 x i8> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 8 x i16> @llvm.aarch64.sve.eor.nxv8i16(<n x 8 x i1> %pg,
                                                          <n x 8 x i16> %a,
                                                          <n x 8 x i16> %b)
  %out = select <n x 8 x i1> %pg, <n x 8 x i16> %tmp, <n x 8 x i16> zeroinitializer
  ret <n x 8 x i16> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 4 x i32> @llvm.aarch64.sve.eor.nxv4i32(<n x 4 x i1> %pg,
                                                          <n x 4 x i32> %a,
                                                          <n x 4 x i32> %b)
  %out = select <n x 4 x i1> %pg, <n x 4 x i32> %tmp, <n x 4 x i32> zeroinitializer
  ret <n x 4 x i32> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 2 x i64> @llvm.aarch64.sve.eor.nxv2i64(<n x 2 x i1> %pg,
                                                          <n x 2 x i64> %a,
                                                          <n x 2 x i64> %b)
  %out = select <n x 2 x i1> %pg, <n x 2 x i64> %tmp, <n x 2 x i64> zeroinitializer
  ret <n x 2 x i64> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 16 x i8> @llvm.aarch64.sve.not.nxv16i8(<n x 16 x i8> %a,
                                                          <n x 16 x i1> %pg,
                                                          <n x 16 x i8> %b)
  %out = select <n x 16 x i1> %pg, <n x 16 x i8> %tmp, <n x 16 x i8> zeroinitializer
  ret <n x 16 x i8> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 8 x i16> @llvm.aarch64.sve.not.nxv8i16(<n x 8 x i16> %a,
                                                          <n x 8 x i1> %pg,
                                                          <n x 8 x i16> %b)
  %out = select <n x 8 x i1> %pg, <n x 8 x i16> %tmp, <n x 8 x i16> zeroinitializer
  ret <n x 8 x i16> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 4 x i32> @llvm.aarch64.sve.not.nxv4i32(<n x 4 x i32> %a,
                                                          <n x 4 x i1> %pg,
                                                          <n x 4 x i32> %b)
  %out = select <n x 4 x i1> %pg, <n x 4 x i32> %tmp, <n x 4 x i32> zeroinitializer
  ret <n x 4 x i32> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 2 x i64> @llvm.aarch64.sve.not.nxv2i64(<n x 2 x i64> %a,
                                                          <n x 2 x i1> %pg,
                                                          <n x 2 x i64> %b)
  %out = select <n x 2 x i1> %pg, <n x 2 x i64> %tmp, <n x 2 x i64> zeroinitializer
  ret <n x 2 x i64> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 16 x i8> @llvm.aarch64.sve.orr.nxv16i8(<n x 16 x i1> %pg,
                                                          <n x 16 x i8> %a,
                                                          <n x 16 x i8> %b)
  %out = select <n x 16 x i1> %pg, <n x 16 x i8> %tmp, <n x 16 x i8> zeroinitializer
  ret <n x 16 x i8> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 8 x i16> @llvm.aarch64.sve.orr.nxv8i16(<n x 8 x i1> %pg,
                                                          <n x 8 x i16> %a,
                                                          <n x 8 x i16> %b)
  %out = select <n x 8 x i1> %pg, <n x 8 x i16> %tmp, <n x 8 x i16> zeroinitializer
  ret <n x 8 x i16> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 4 x i32> @llvm.aarch64.sve.orr.nxv4i32(<n x 4 x i1> %pg,
                                                          <n x 4 x i32> %a,
                                                          <n x 4 x i32> %b)
  %out = select <n x 4 x i1> %pg, <n x 4 x i32> %tmp, <n x 4 x i32> zeroinitializer
  ret <n x 4 x i32> %out
...
; CHECK-NEXT: ret
  %tmp = call <n x 2 x i64> @llvm.aarch64.sve.orr.nxv2i64(<n x 2 x i1> %pg,
                                                          <n x 2 x i64> %a,
                                                          <n x 2 x i64> %b)
  %out = select <n x 2 x i1> %pg, <n x 2 x i64> %tmp, <n x 2 x i64> zeroinitializer
  ret <n x 2 x i64> %out
