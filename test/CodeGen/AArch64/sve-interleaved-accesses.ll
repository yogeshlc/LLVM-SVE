...
define void @st2_2_i16(<n x 8 x i16> %val1, <n x 8 x i16> %val2, i16* %ptr, i64 %index, <n x 8 x i1> %predicate) {
  %sv = seriesvector i64 %index, 2 as <n x 8 x i64>
...
define void @st2_2_i32(<n x 4 x i32> %val1, <n x 4 x i32> %val2, i32* %ptr, i64 %index, <n x 4 x i1> %predicate) {
  %sv = seriesvector i64 %index, 2 as <n x 4 x i64>
  %gep1 = getelementptr i32, i32* %ptr, <n x 4 x i64> %sv
  call void @llvm.masked.scatter.nxv4i32(<n x 4 x i32> %val1, <n x 4 x i32*> %gep1, i32 4, <n x 4 x i1> %predicate)
  %ptr2 = getelementptr i32, i32* %ptr, i32 1
  %gep2 = getelementptr i32, i32* %ptr2, <n x 4 x i64> %sv
  call void @llvm.masked.scatter.nxv4i32(<n x 4 x i32> %val2, <n x 4 x i32*> %gep2, i32 4, <n x 4 x i1> %predicate)
  ret void
}
...
define void @st2_2_i64(<n x 2 x i64> %val1, <n x 2 x i64> %val2, i64* %ptr, i64 %index, <n x 2 x i1> %predicate) {
  %sv = seriesvector i64 %index, 2 as <n x 2 x i64>
  %gep1 = getelementptr i64, i64* %ptr, <n x 2 x i64> %sv
  call void @llvm.masked.scatter.nxv2i64(<n x 2 x i64> %val1, <n x 2 x i64*> %gep1, i32 4, <n x 2 x i1> %predicate)
  %ptr2 = getelementptr i64, i64* %ptr, i64 1
  %gep2 = getelementptr i64, i64* %ptr2, <n x 2 x i64> %sv
  call void @llvm.masked.scatter.nxv2i64(<n x 2 x i64> %val2, <n x 2 x i64*> %gep2, i32 4, <n x 2 x i1> %predicate)
  ret void
}
...
define void @st2_2_double(<n x 2 x double> %val1, <n x 2 x double> %val2, double* %ptr, i64 %index, <n x 2 x i1> %predicate) {
  ...
  call void @llvm.masked.scatter.nxv2f64(<n x 2 x double> %val2, <n x 2 x double*> %gep2, i32 4, <n x 2 x i1> %predicate)
  ret void
}
...
define void @st3_3_i8(<n x 16 x i8> %val1, <n x 16 x i8> %val2, <n x 16 x i8> %val3, i8* %ptr, i64 %index, <n x 16 x i1> %predicate) {
  %sv = seriesvector i64 %index, 3 as <n x 16 x i64>
  %gep1 = getelementptr i8, i8* %ptr, <n x 16 x i64> %sv
  call void @llvm.masked.scatter.nxv16i8(<n x 16 x i8> %val1, <n x 16 x i8*> %gep1, i32 4, <n x 16 x i1> %predicate)
  %ptr2 = getelementptr i8, i8* %ptr, i8 1
  %gep2 = getelementptr i8, i8* %ptr2, <n x 16 x i64> %sv
  ...
  call void @llvm.masked.scatter.nxv16i8(<n x 16 x i8> %val3, <n x 16 x i8*> %gep3, i32 4, <n x 16 x i1> %predicate)
  ret void
}
...
define void @st3_3_i16(<n x 8 x i16> %val1, <n x 8 x i16> %val2, <n x 8 x i16> %val3, i16* %ptr, i64 %index, <n x 8 x i1> %predicate) {
  %sv = seriesvector i64 %index, 3 as <n x 8 x i64>
  %gep1 = getelementptr i16, i16* %ptr, <n x 8 x i64> %sv
  call void @llvm.masked.scatter.nxv8i16(<n x 8 x i16> %val1, <n x 8 x i16*> %gep1, i32 4, <n x 8 x i1> %predicate)
  %ptr2 = getelementptr i16, i16* %ptr, i16 1
  %gep2 = getelementptr i16, i16* %ptr2, <n x 8 x i64> %sv
...
define void @st3_3_i32(<n x 4 x i32> %val1, <n x 4 x i32> %val2, <n x 4 x i32> %val3, i32* %ptr, i64 %index, <n x 4 x i1> %predicate) {
  %sv = seriesvector i64 %index, 3 as <n x 4 x i64>
  %gep1 = getelementptr i32, i32* %ptr, <n x 4 x i64> %sv
  call void @llvm.masked.scatter.nxv4i32(<n x 4 x i32> %val1, <n x 4 x i32*> %gep1, i32 4, <n x 4 x i1> %predicate)
  %ptr2 = getelementptr i32, i32* %ptr, i32 1
  %gep2 = getelementptr i32, i32* %ptr2, <n x 4 x i64> %sv
  ...
  call void @llvm.masked.scatter.nxv4i32(<n x 4 x i32> %val3, <n x 4 x i32*> %gep3, i32 4, <n x 4 x i1> %predicate)
  ret void
}
...
define void @st3_3_i64(<n x 2 x i64> %val1, <n x 2 x i64> %val2, <n x 2 x i64> %val3, i64* %ptr, i64 %index, <n x 2 x i1> %predicate) {
  %sv = seriesvector i64 %index, 3 as <n x 2 x i64>
  %gep1 = getelementptr i64, i64* %ptr, <n x 2 x i64> %sv
  call void @llvm.masked.scatter.nxv2i64(<n x 2 x i64> %val1, <n x 2 x i64*> %gep1, i32 4, <n x 2 x i1> %predicate)
  %ptr2 = getelementptr i64, i64* %ptr, i64 1
  %gep2 = getelementptr i64, i64* %ptr2, <n x 2 x i64> %sv
  ...
  call void @llvm.masked.scatter.nxv2i64(<n x 2 x i64> %val3, <n x 2 x i64*> %gep3, i32 4, <n x 2 x i1> %predicate)
  ret void
}
...
define void @st3_6_double(<n x 2 x double> %val1, <n x 2 x double> %val2, <n x 2 x double> %val3,
                          <n x 2 x double> %val4, <n x 2 x double> %val5, <n x 2 x double> %val6,
                          double* %ptr, i64 %index, <n x 2 x i1> %predicate) {
  %sv = seriesvector i64 %index, 6 as <n x 2 x i64>
  %gep1 = getelementptr double, double* %ptr, <n x 2 x i64> %sv
  call void @llvm.masked.scatter.nxv2f64(<n x 2 x double> %val1, <n x 2 x double*> %gep1, i32 4, <n x 2 x i1> %predicate)
  %ptr2 = getelementptr double, double* %ptr, i64 1
  %gep2 = getelementptr double, double* %ptr2, <n x 2 x i64> %sv
  ...
  call void @llvm.masked.scatter.nxv2f64(<n x 2 x double> %val5, <n x 2 x double*> %gep5, i32 4, <n x 2 x i1> %predicate)
...
define void @st4_4_i8(<n x 16 x i8> %val1, <n x 16 x i8> %val2, <n x 16 x i8> %val3, <n x 16 x i8> %val4, i8* %ptr, i64 %index, <n x 16 x i1> %predicate) {
  %sv = seriesvector i64 %index, 4 as <n x 16 x i64>
  %gep1 = getelementptr i8, i8* %ptr, <n x 16 x i64> %sv
  call void @llvm.masked.scatter.nxv16i8(<n x 16 x i8> %val1, <n x 16 x i8*> %gep1, i32 4, <n x 16 x i1> %predicate)
  %ptr2 = getelementptr i8, i8* %ptr, i8 1
  %gep2 = getelementptr i8, i8* %ptr2, <n x 16 x i64> %sv
  ...
  call void @llvm.masked.scatter.nxv16i8(<n x 16 x i8> %val4, <n x 16 x i8*> %gep4, i32 4, <n x 16 x i1> %predicate)
  ret void
}
...
define void @st4_4_i16(<n x 8 x i16> %val1, <n x 8 x i16> %val2, <n x 8 x i16> %val3, <n x 8 x i16> %val4, i16* %ptr, i64 %index, <n x 8 x i1> %predicate) {
  %sv = seriesvector i64 %index, 4 as <n x 8 x i64>
  %gep1 = getelementptr i16, i16* %ptr, <n x 8 x i64> %sv
  call void @llvm.masked.scatter.nxv8i16(<n x 8 x i16> %val1, <n x 8 x i16*> %gep1, i32 4, <n x 8 x i1> %predicate)
  %ptr2 = getelementptr i16, i16* %ptr, i16 1
  %gep2 = getelementptr i16, i16* %ptr2, <n x 8 x i64> %sv
  ...
  call void @llvm.masked.scatter.nxv8i16(<n x 8 x i16> %val4, <n x 8 x i16*> %gep4, i32 4, <n x 8 x i1> %predicate)
  ret void
}
...
define void @st4_4_i32(<n x 4 x i32> %val1, <n x 4 x i32> %val2, <n x 4 x i32> %val3, <n x 4 x i32> %val4, i32* %ptr, i64 %index, <n x 4 x i1> %predicate) {
  %sv = seriesvector i64 %index, 4 as <n x 4 x i64>
  %gep1 = getelementptr i32, i32* %ptr, <n x 4 x i64> %sv
  call void @llvm.masked.scatter.nxv4i32(<n x 4 x i32> %val1, <n x 4 x i32*> %gep1, i32 4, <n x 4 x i1> %predicate)
  %ptr2 = getelementptr i32, i32* %ptr, i32 1
  %gep2 = getelementptr i32, i32* %ptr2, <n x 4 x i64> %sv
  ...
  call void @llvm.masked.scatter.nxv4i32(<n x 4 x i32> %val4, <n x 4 x i32*> %gep4, i32 4, <n x 4 x i1> %predicate)
  ret void
}
...
define void @st4_4_i64(<n x 2 x i64> %val1, <n x 2 x i64> %val2, <n x 2 x i64> %val3, <n x 2 x i64> %val4, i64* %ptr, i64 %index, <n x 2 x i1> %predicate) {
  %sv = seriesvector i64 %index, 4 as <n x 2 x i64>
  %gep1 = getelementptr i64, i64* %ptr, <n x 2 x i64> %sv
  call void @llvm.masked.scatter.nxv2i64(<n x 2 x i64> %val1, <n x 2 x i64*> %gep1, i32 4, <n x 2 x i1> %predicate)
  %ptr2 = getelementptr i64, i64* %ptr, i64 1
  %gep2 = getelementptr i64, i64* %ptr2, <n x 2 x i64> %sv
  ...
  call void @llvm.masked.scatter.nxv2i64(<n x 2 x i64> %val4, <n x 2 x i64*> %gep4, i32 4, <n x 2 x i1> %predicate)
  ret void
}
...
define <n x 16 x i8> @ld2_1_i8(i8* %ptr, i64 %index, <n x 16 x i1> %predicate) {
  ...
  %res = call <n x 16 x i8> @llvm.masked.gather.nxv16i8(<n x 16 x i8*> %gep, i32 4, <n x 16 x i1> %predicate, <n x 16 x i8> undef)
  ret <n x 16 x i8> %res
}
...
define <n x 16 x i8> @ld2_2_i8(i8* %ptr, i64 %index, <n x 16 x i1> %predicate) {
  %sv = seriesvector i64 %index, 2 as <n x 16 x i64>
  %gep1 = getelementptr i8, i8* %ptr, <n x 16 x i64> %sv
  %res1 = call <n x 16 x i8> @llvm.masked.gather.nxv16i8(<n x 16 x i8*> %gep1, i32 4, <n x 16 x i1> %predicate, <n x 16 x i8> undef)
  %ptr2 = getelementptr i8, i8* %ptr, i8 1
  %gep2 = getelementptr i8, i8* %ptr2, <n x 16 x i64> %sv
  %res2 = call <n x 16 x i8> @llvm.masked.gather.nxv16i8(<n x 16 x i8*> %gep2, i32 4, <n x 16 x i1> %predicate, <n x 16 x i8> undef)
...
define <n x 8 x i16> @ld2_1_i16(i16* %ptr, i64 %index, <n x 8 x i1> %predicate) {
  ...
  %res = call <n x 8 x i16> @llvm.masked.gather.nxv8i16(<n x 8 x i16*> %gep, i32 4, <n x 8 x i1> %predicate, <n x 8 x i16> undef)
  ret <n x 8 x i16> %res
}
...
define <n x 8 x i16> @ld2_2_i16(i16* %ptr, i64 %index, <n x 8 x i1> %predicate) {
  %sv = seriesvector i64 %index, 2 as <n x 8 x i64>
  %gep1 = getelementptr i16, i16* %ptr, <n x 8 x i64> %sv
  %res1 = call <n x 8 x i16> @llvm.masked.gather.nxv8i16(<n x 8 x i16*> %gep1, i32 4, <n x 8 x i1> %predicate, <n x 8 x i16> undef)
  %ptr2 = getelementptr i16, i16* %ptr, i16 1
  %gep2 = getelementptr i16, i16* %ptr2, <n x 8 x i64> %sv
  %res2 = call <n x 8 x i16> @llvm.masked.gather.nxv8i16(<n x 8 x i16*> %gep2, i32 4, <n x 8 x i1> %predicate, <n x 8 x i16> undef)
...
define <n x 4 x i32> @ld2_1_i32(i32* %ptr, i64 %index, <n x 4 x i1> %predicate) {
  ...
  %res = call <n x 4 x i32> @llvm.masked.gather.nxv4i32(<n x 4 x i32*> %gep, i32 4, <n x 4 x i1> %predicate, <n x 4 x i32> undef)
  ret <n x 4 x i32> %res
}
...
define <n x 2 x i64> @ld2_1_i64(i64* %ptr, i64 %index, <n x 2 x i1> %predicate) {
  ...
  %res = call <n x 2 x i64> @llvm.masked.gather.nxv2i64(<n x 2 x i64*> %gep, i32 8, <n x 2 x i1> %predicate, <n x 2 x i64> undef)
  ret <n x 2 x i64> %res
}
...
define <n x 4 x float> @ld2_1_float(float* %ptr, i64 %index, <n x 4 x i1> %predicate) {
  ...
  %res = call <n x 4 x float> @llvm.masked.gather.nxv4f32(<n x 4 x float*> %gep, i32 4, <n x 4 x i1> %predicate, <n x 4 x float> undef)
...
define <n x 4 x float> @ld2_2_float(float* %ptr, i64 %index, <n x 4 x i1> %predicate) {
  %sv = seriesvector i64 %index, 2 as <n x 4 x i64>
  %gep1 = getelementptr float, float* %ptr, <n x 4 x i64> %sv
  %res1 = call <n x 4 x float> @llvm.masked.gather.nxv4f32(<n x 4 x float*> %gep1, i32 4, <n x 4 x i1> %predicate, <n x 4 x float> undef)
  %ptr2 = getelementptr float, float* %ptr, i32 1
  %gep2 = getelementptr float, float* %ptr2, <n x 4 x i64> %sv
  %res2 = call <n x 4 x float> @llvm.masked.gather.nxv4f32(<n x 4 x float*> %gep2, i32 4, <n x 4 x i1> %predicate, <n x 4 x float> undef)
...
define <n x 2 x double> @ld2_1_double(double* %ptr, i64 %index, <n x 2 x i1> %predicate) {
  ...
  %res = call <n x 2 x double> @llvm.masked.gather.nxv2f64(<n x 2 x double*> %gep, i32 8, <n x 2 x i1> %predicate, <n x 2 x double> undef)
...
define <n x 2 x double> @ld2_2_double(double* %ptr, i64 %index, <n x 2 x i1> %predicate) {
  %sv = seriesvector i64 %index, 2 as <n x 2 x i64>
  %gep1 = getelementptr double, double* %ptr, <n x 2 x i64> %sv
  %res1 = call <n x 2 x double> @llvm.masked.gather.nxv2f64(<n x 2 x double*> %gep1, i32 8, <n x 2 x i1> %predicate, <n x 2 x double> undef)
  %ptr2 = getelementptr double, double* %ptr, i32 1
  %gep2 = getelementptr double, double* %ptr2, <n x 2 x i64> %sv
  %res2 = call <n x 2 x double> @llvm.masked.gather.nxv2f64(<n x 2 x double*> %gep2, i32 8, <n x 2 x i1> %predicate, <n x 2 x double> undef)
...
define <n x 16 x i8> @ld3_3_i8(i8* %ptr, i64 %index, <n x 16 x i1> %predicate) {
  ...
  %gep3 = getelementptr i8, i8* %ptr3, <n x 16 x i64> %sv
  %res3 = call <n x 16 x i8> @llvm.masked.gather.nxv16i8(<n x 16 x i8*> %gep3, i32 4, <n x 16 x i1> %predicate, <n x 16 x i8> undef)
...
define <n x 8 x i16> @ld3_3_i16(i16* %ptr, i64 %index, <n x 8 x i1> %predicate) {
  ...
  %gep3 = getelementptr i16, i16* %ptr3, <n x 8 x i64> %sv
  %res3 = call <n x 8 x i16> @llvm.masked.gather.nxv8i16(<n x 8 x i16*> %gep3, i32 4, <n x 8 x i1> %predicate, <n x 8 x i16> undef)
...
define <n x 2 x i64> @ld3_3_i64(i64* %ptr, i64 %index, <n x 2 x i1> %predicate) {
  %sv = seriesvector i64 %index, 3 as <n x 2 x i64>
  %gep1 = getelementptr i64, i64* %ptr, <n x 2 x i64> %sv
  %res1 = call <n x 2 x i64> @llvm.masked.gather.nxv2i64(<n x 2 x i64*> %gep1, i32 4, <n x 2 x i1> %predicate, <n x 2 x i64> undef)
  %ptr2 = getelementptr i64, i64* %ptr, i64 1
  %gep2 = getelementptr i64, i64* %ptr2, <n x 2 x i64> %sv
  %res2 = call <n x 2 x i64> @llvm.masked.gather.nxv2i64(<n x 2 x i64*> %gep2, i32 4, <n x 2 x i1> %predicate, <n x 2 x i64> undef)
  %ptr3 = getelementptr i64, i64* %ptr, i64 2
  %gep3 = getelementptr i64, i64* %ptr3, <n x 2 x i64> %sv
  %res3 = call <n x 2 x i64> @llvm.masked.gather.nxv2i64(<n x 2 x i64*> %gep3, i32 4, <n x 2 x i1> %predicate, <n x 2 x i64> undef)
...
define <n x 4 x float> @ld3_3_float(float* %ptr, i64 %index, <n x 4 x i1> %predicate) {
  ...
  %ptr3 = getelementptr float, float* %ptr, i32 2
  %gep3 = getelementptr float, float* %ptr3, <n x 4 x i64> %sv
  %res3 = call <n x 4 x float> @llvm.masked.gather.nxv4f32(<n x 4 x float*> %gep3, i32 4, <n x 4 x i1> %predicate, <n x 4 x float> undef)
...
define <n x 2 x double> @ld3_6_double(double* %ptr, i64 %index, <n x 2 x i1> %predicate) {
  ...
  %gep5 = getelementptr double, double* %ptr5, <n x 2 x i64> %sv
  %res5 = call <n x 2 x double> @llvm.masked.gather.nxv2f64(<n x 2 x double*> %gep5, i32 4, <n x 2 x i1> %predicate, <n x 2 x double> undef)
  %ptr6 = getelementptr double, double* %ptr, i64 5
  %gep6 = getelementptr double, double* %ptr6, <n x 2 x i64> %sv
  %res6 = call <n x 2 x double> @llvm.masked.gather.nxv2f64(<n x 2 x double*> %gep6, i32 4, <n x 2 x i1> %predicate, <n x 2 x double> undef)
  %res12 = fadd <n x 2 x double> %res1, %res2
...
define <n x 16 x i8> @ld4_4_i8(i8* %ptr, i64 %index, <n x 16 x i1> %predicate) {
  ...
  %gep4 = getelementptr i8, i8* %ptr4, <n x 16 x i64> %sv
  %res4 = call <n x 16 x i8> @llvm.masked.gather.nxv16i8(<n x 16 x i8*> %gep4, i32 4, <n x 16 x i1> %predicate, <n x 16 x i8> undef)
  %res12 = add <n x 16 x i8> %res1, %res2
...
define <n x 8 x i16> @ld4_4_i16(i16* %ptr, i64 %index, <n x 8 x i1> %predicate) {
  ...
  %gep4 = getelementptr i16, i16* %ptr4, <n x 8 x i64> %sv
  %res4 = call <n x 8 x i16> @llvm.masked.gather.nxv8i16(<n x 8 x i16*> %gep4, i32 4, <n x 8 x i1> %predicate, <n x 8 x i16> undef)
  %res12 = add <n x 8 x i16> %res1, %res2
...
define <n x 4 x i32> @ld4_4_i32(i32* %ptr, i64 %index, <n x 4 x i1> %predicate) {
  ...
  %ptr4 = getelementptr i32, i32* %ptr, i32 3
  %gep4 = getelementptr i32, i32* %ptr4, <n x 4 x i64> %sv
  %res4 = call <n x 4 x i32> @llvm.masked.gather.nxv4i32(<n x 4 x i32*> %gep4, i32 4, <n x 4 x i1> %predicate, <n x 4 x i32> undef)
  %res12 = add <n x 4 x i32> %res1, %res2
...
define <n x 2 x i64> @ld4_4_i64(i64* %ptr, i64 %index, <n x 2 x i1> %predicate) {
  ...
  %gep4 = getelementptr i64, i64* %ptr4, <n x 2 x i64> %sv
  %res4 = call <n x 2 x i64> @llvm.masked.gather.nxv2i64(<n x 2 x i64*> %gep4, i32 4, <n x 2 x i1> %predicate, <n x 2 x i64> undef)
  %res12 = add <n x 2 x i64> %res1, %res2
...
define <n x 4 x float> @ld4_4_float(float* %ptr, i64 %index, <n x 4 x i1> %predicate) {
  ...
  %ptr4 = getelementptr float, float* %ptr, i32 3
  %gep4 = getelementptr float, float* %ptr4, <n x 4 x i64> %sv
  %res4 = call <n x 4 x float> @llvm.masked.gather.nxv4f32(<n x 4 x float*> %gep4, i32 4, <n x 4 x i1> %predicate, <n x 4 x float> undef)
  %res12 = fadd <n x 4 x float> %res1, %res2
...
define <n x 2 x double> @two_load_groups(double* %ptr, i64 %index1, i64 %index2, <n x 2 x i1> %predicate) {
  %sv1 = seriesvector i64 %index1, 2 as <n x 2 x i64>
  ...
  %res2 = call <n x 2 x double> @llvm.masked.gather.nxv2f64(<n x 2 x double*> %gep2, i32 4, <n x 2 x i1> %predicate, <n x 2 x double> undef)
  %res12 = fadd <n x 2 x double> %res1, %res2
  %sv2 = seriesvector i64 %index2, 2 as <n x 2 x i64>
...
define <n x 2 x double> @load_store_load(double* %ptr, i64 %index1, i64 %index2, <n x 2 x double> %val1, <n x 2 x double> %val2, <n x 2 x i1> %predicate) {
  %loadsv = seriesvector i64 %index1, 2 as <n x 2 x i64>
  %loadgep1 = getelementptr double, double* %ptr, <n x 2 x i64> %loadsv
  %res1 = call <n x 2 x double> @llvm.masked.gather.nxv2f64(<n x 2 x double*> %loadgep1, i32 4, <n x 2 x i1> %predicate, <n x 2 x double> undef)
  %storesv = seriesvector i64 %index2, 2 as <n x 2 x i64>
  %storegep1 = getelementptr double, double* %ptr, <n x 2 x i64> %storesv
  call void @llvm.masked.scatter.nxv2f64(<n x 2 x double> %val1, <n x 2 x double*> %storegep1, i32 4, <n x 2 x i1> %predicate)
  %ptr2 = getelementptr double, double* %ptr, i32 1
  %storegep2 = getelementptr double, double* %ptr2, <n x 2 x i64> %storesv
  call void @llvm.masked.scatter.nxv2f64(<n x 2 x double> %val2, <n x 2 x double*> %storegep2, i32 4, <n x 2 x i1> %predicate)
  %loadgep2 = getelementptr double, double* %ptr2, <n x 2 x i64> %loadsv
  %res2 = call <n x 2 x double> @llvm.masked.gather.nxv2f64(<n x 2 x double*> %loadgep2, i32 4, <n x 2 x i1> %predicate, <n x 2 x double> undef)
  %res12 = fadd <n x 2 x double> %res1, %res2
...
define <n x 2 x double> @store_load_store(double* %ptr, i64 %index1, i64 %index2, <n x 2 x double> %val1, <n x 2 x double> %val2, <n x 2 x i1> %predicate) {
  %storesv1 = seriesvector i64 %index1, 2 as <n x 2 x i64>
  ...
  call void @llvm.masked.scatter.nxv2f64(<n x 2 x double> %val2, <n x 2 x double*> %storegep2, i32 4, <n x 2 x i1> %predicate)
  %loadsv = seriesvector i64 %index2, 2 as <n x 2 x i64>
  %loadgep1 = getelementptr double, double* %ptr, <n x 2 x i64> %loadsv
  %res = call <n x 2 x double> @llvm.masked.gather.nxv2f64(<n x 2 x double*> %loadgep1, i32 4, <n x 2 x i1> %predicate, <n x 2 x double> undef)
  call void @llvm.masked.scatter.nxv2f64(<n x 2 x double> %val1, <n x 2 x double*> %storegep1, i32 4, <n x 2 x i1> %predicate)
  call void @llvm.masked.scatter.nxv2f64(<n x 2 x double> %val2, <n x 2 x double*> %storegep2, i32 4, <n x 2 x i1> %predicate)
  ret <n x 2 x double> %res
}
...
define <n x 2 x i64> @sub_element_stride(i32* %base, <n x 2 x i1> %pred) {
  %sv = seriesvector i64 0, 1 as <n x 2 x i64>
  %gep1 = getelementptr i32, i32* %base, <n x 2 x i64> %sv
  %bc1 = bitcast <n x 2 x i32*> %gep1 to <n x 2 x i64*>
  %wmg1 = call <n x 2 x i64> @llvm.masked.gather.nxv2i64(<n x 2 x i64*> %bc1, i32 4, <n x 2 x i1> %pred, <n x 2 x i64> undef)
  ...
  %wmg2 = call <n x 2 x i64> @llvm.masked.gather.nxv2i64(<n x 2 x i64*> %bc2, i32 4, <n x 2 x i1> %pred, <n x 2 x i64> undef)
...
define {<n x 2 x double>, <n x 2 x i64>} @mixed_loads(double* %doubleptr, i64 %index, <n x 2 x i1> %predicate) {
  ...
  %i64res1 = call <n x 2 x i64> @llvm.masked.gather.nxv2i64(<n x 2 x i64*> %i64gep1, i32 4, <n x 2 x i1> %predicate, <n x 2 x i64> undef)
  %doubleres = call <n x 2 x double> @llvm.masked.gather.nxv2f64(<n x 2 x double*> %doublegep, i32 4, <n x 2 x i1> %predicate, <n x 2 x double> undef)
  %i64res2 = call <n x 2 x i64> @llvm.masked.gather.nxv2i64(<n x 2 x i64*> %i64gep2, i32 4, <n x 2 x i1> %predicate, <n x 2 x i64> undef)
...
define void @mixed_stores(<n x 2 x double> %doubleval, <n x 2 x i64> %i64val, double* %doubleptr1, i64 %index, <n x 2 x i1> %predicate) {
  ...
  %i64gep1 = getelementptr i64, i64* %i64ptr1, <n x 2 x i64> %sv
  %i64gep2 = getelementptr i64, i64* %i64ptr2, <n x 2 x i64> %sv
  call void @llvm.masked.scatter.nxv2f64(<n x 2 x double> %doubleval, <n x 2 x double*> %doublegep1, i32 4, <n x 2 x i1> %predicate)
  call void @llvm.masked.scatter.nxv2i64(<n x 2 x i64> %i64val, <n x 2 x i64*> %i64gep2, i32 4, <n x 2 x i1> %predicate)
  call void @llvm.masked.scatter.nxv2f64(<n x 2 x double> %doubleval, <n x 2 x double*> %doublegep2, i32 4, <n x 2 x i1> %predicate)
  call void @llvm.masked.scatter.nxv2i64(<n x 2 x i64> %i64val, <n x 2 x i64*> %i64gep1, i32 4, <n x 2 x i1> %predicate)
  ret void
}
