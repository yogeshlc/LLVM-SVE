...
; CHECK-DAG: ptrue [[PG:p[0-9]+]].d
; CHECK-DAG: zip1 [[LOLO:z[0-9]+]].s, z0.s, z0.s
; CHECK-DAG: zip2 [[LOHI:z[0-9]+]].s, z0.s, z0.s
; CHECK-DAG: zip1 [[HILO:z[0-9]+]].s, z1.s, z1.s
; CHECK-DAG: zip2 [[HIHI:z[0-9]+]].s, z1.s, z1.s
; CHECK-DAG: fcvt z0.d, [[PG]]/m, [[LOLO]].s
; CHECK-DAG: fcvt z1.d, [[PG]]/m, [[LOHI]].s
; CHECK-DAG: fcvt z2.d, [[PG]]/m, [[HILO]].s
; CHECK-DAG: fcvt z3.d, [[PG]]/m, [[HIHI]].s
; CHECK: ret
