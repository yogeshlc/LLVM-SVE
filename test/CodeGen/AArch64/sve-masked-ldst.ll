...
; CHECK-BAD: ld1d {{{z[0-9]+}}.d}, {{p[0-9]+}}/z, [{{x[0-9]+}}]
; CHECK-BAD: ld1d {{{z[0-9]+}}.d}, {{p[0-9]+}}/z, [{{x[0-9]+}}]
; CHECK-NOT-BAD: ld1d {{{z[0-9]+}}.d}, {{p[0-9]+}}/z, [{{x[0-9]+}}, xzr, lsl #3]
...
; CHECK-BAD: st1d {{{z[0-9]+}}.d}, {{p[0-9]+}}, [{{x[0-9]+}}]
; CHECK-BAD: st1d {{{z[0-9]+}}.d}, {{p[0-9]+}}, [{{x[0-9]+}}]
; CHECK-NOT-BAD: st1d {{{z[0-9]+}}.d}, {{p[0-9]+}}, [{{x[0-9]+}}, xzr, lsl #3]
; CHECK: ret
  %bit = insertelement <n x 16 x i1> undef, i1 1, i32 0
  %mask = shufflevector <n x 16 x i1> %bit, <n x 16 x i1> undef, <n x 16 x i32> zeroinitializer
...
; CHECK-DAG: setffr
; CHECK: ldff1b {[[DATA:z[0-9]+]].d}, [[PG]]/z, [x0, xzr]
...
; CHECK-DAG: ptrue [[PG:p[0-9]+]].d
; CHECK-DAG: setffr
; CHECK: ldff1h {[[DATA:z[0-9]+]].d}, [[PG]]/z, [x0, xzr, lsl #1]
; CHECK: rdffr [[FFR:p[0-9]+]].b, [[PG]]
...
; CHECK-DAG: ptrue [[PG:p[0-9]+]].d
; CHECK-DAG: setffr
; CHECK: ldff1w {[[DATA:z[0-9]+]].d}, [[PG]]/z, [x0, xzr, lsl #2]
; CHECK: rdffr [[FFR:p[0-9]+]].b, [[PG]]
...
; CHECK-DAG: ptrue [[PG:p[0-9]+]].d
; CHECK-DAG: setffr
; CHECK: ldff1d {[[DATA:z[0-9]+]].d}, [[PG]]/z, [x0, xzr, lsl #3]
; CHECK: rdffr [[FFR:p[0-9]+]].b, [[PG]]
...
; CHECK-DAG: setffr
; CHECK: ldff1b {[[DATA:z[0-9]+]].s}, [[PG]]/z, [x0, xzr]
; CHECK: rdffr [[FFR:p[0-9]+]].b, [[PG]]
...
; CHECK-DAG: ptrue [[PG:p[0-9]+]].s
; CHECK-DAG: setffr
; CHECK: ldff1h {[[DATA:z[0-9]+]].s}, [[PG]]/z, [x0, xzr, lsl #1]
; CHECK: rdffr [[FFR:p[0-9]+]].b, [[PG]]
...
; CHECK-DAG: ptrue [[PG:p[0-9]+]].s
; CHECK-DAG: setffr
; CHECK: ldff1w {[[DATA:z[0-9]+]].s}, [[PG]]/z, [x0, xzr, lsl #2]
; CHECK: rdffr [[FFR:p[0-9]+]].b, [[PG]]
...
; CHECK-DAG: setffr
; CHECK: ldff1b {[[DATA:z[0-9]+]].h}, [[PG]]/z, [x0, xzr]
; CHECK: rdffr [[FFR:p[0-9]+]].b, [[PG]]
...
; CHECK-DAG: ptrue [[PG:p[0-9]+]].h
; CHECK-DAG: setffr
; CHECK: ldff1h {[[DATA:z[0-9]+]].h}, [[PG]]/z, [x0, xzr, lsl #1]
; CHECK: rdffr [[FFR:p[0-9]+]].b, [[PG]]
...
; CHECK-DAG: setffr
; CHECK: ldff1b {[[DATA:z[0-9]+]].b}, [[PG]]/z, [x0, xzr]
; CHECK: rdffr [[FFR:p[0-9]+]].b, [[PG]]
