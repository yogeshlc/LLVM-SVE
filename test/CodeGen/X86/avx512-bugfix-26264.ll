...
; AVX512BW-NEXT:    vmovupd 64(%rdi), %zmm2 {%k2}
; AVX512BW-NEXT:    kshiftrd $16, %k1, %k1
; AVX512BW-NEXT:    vmovupd 128(%rdi), %zmm3 {%k1}
...
; AVX512BW-NEXT:    kshiftrw $8, %k1, %k2
; AVX512BW-NEXT:    vmovdqu64 64(%rdi), %zmm2 {%k2}
; AVX512BW-NEXT:    kshiftrd $16, %k1, %k1
; AVX512BW-NEXT:    vmovdqu64 128(%rdi), %zmm3 {%k1}
; AVX512BW-NEXT:    kshiftrw $8, %k1, %k1
