...
class SVEVecStackRegion : public StackRegion {
  /// Scale is 1 for SVE Predicate regions, 8 for Vector regions,
  /// because 1 SVE vector has the size of 8 predicate registers.
  int  Scale;
...
public:
  ...
  ///                         whether to add or subtract this value from the
  ///                         SP.
  ...
  static unsigned adjustRegBySVE(MachineFunction &MF,
                                   ...
                                   DebugLoc DL,
                                   unsigned Basereg,
                                   uint64_t Size, bool IsPositiveOffset,
                                   unsigned Dst = 0);
