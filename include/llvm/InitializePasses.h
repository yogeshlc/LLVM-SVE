...
void initializeInitStackRegionPassPass(PassRegistry&);
...
void initializeBlameFunctionPassWrapperPass(PassRegistry&);
void initializeBlameModulePassWrapperPass(PassRegistry&);
